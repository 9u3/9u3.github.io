local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/vKhonshu/intro2/main/ui2"))()
    ...
    NotifyLib.prompt('Hella - Q To Lock', 'Loading..', 5)
                ...
                if getgenv().loltoggle then
                    ...
                    if Locking then
                        ...
                        if getgenv().ChatMode == true then
                            local A_3 = "zrpx: "..Plr.DisplayName
                            local A_4 = "All"
...
local window = library:new({textsize = 13.5,font = Enum.Font.RobotoMono,name = "Hella V2",color = Color3.fromRGB(204, 255, 255)})
...
section1:button({name = "Hella",callback = function()
    if game.PlaceId == 2788229376 then
        print'da hood'

    NotifyLib.prompt('Game Detected: Da Hood', 'zrpx', 5)
            Settings = {
            rewrittenmain = {
            Enabled = true,
            Key = "q",
    ...
    NotifyLib.prompt('Game Detected: Hood Modded', 'zrpx', 5)
            Settings = {
            rewrittenmain = {
            Enabled = true,
            Key = "q",
...
function getClosestPlayerToCursor()
   ...
   return closestPlayer
    ...
    if game.PlaceId == 9183932460 then
        print'Untitled Hood'
    NotifyLib.prompt('Game Detected: Untitled Hood', 'zrpx', 5)
            Settings = {
            rewrittenmain = {
            Enabled = true,
            Key = "q",
